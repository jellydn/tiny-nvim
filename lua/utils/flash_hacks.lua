-- Patched flash.hacks for Neovim 0.13+ (neovim#39485 SearchState).
-- Upstream: https://github.com/folke/flash.nvim/pull/496
-- Remove once folke/flash.nvim merges 0.13 search-state support.
